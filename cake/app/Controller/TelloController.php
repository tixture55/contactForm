...
class TelloController extends AppController
{
	/** ビュー未使用 */
    ...
    $radio = $this->User->find('list', array('fields' => array('id', 'nickname')));
		$this->set('radio', $radio);
		$this->render('/tello/test');
